...
(function ($, window, document) {
    ...
    var Paginator = function (element, options) {
        ...
        this.options.limitPagination = Math.min(this.options.limitPagination, this.totalPages);
    ...
    Paginator.prototype = {
        pagination: function (type, page) {
            var _self = this;
            var a = $('<a></a>').attr('href', '#');
            var cssClass = type === 'number' ? _self.options.liClass : type + ' ' + _self.options.liClass;
            var text = '';
            if (type === 'number') {
                text = page;
